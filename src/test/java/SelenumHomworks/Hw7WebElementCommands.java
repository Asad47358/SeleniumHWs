...
//hey devs please take a look at the acceptance criteria as this text don't match the one on the website!!!
...
//get the value of attribute title
        ...
        WebElement chechBox = driver.findElement(By.xpath("//input[@value='CheckboxFirst']"));
       if(chechBox.isEnabled()) {
           chechBox.click();
       }

       WebElement checkBox= driver.findElement(By.xpath("//input[@value='disabledCheckbox']"));
      boolean ch = checkBox.isDisplayed();
